                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ route('supplier.update', $id) }}">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone_2" class="form-control form-control-user"
                                                placeholder="Enter Phone Number 2..." value="{{ $supplier->phone_2 }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Company Address <sup
                                                    class="text-danger">*</sup></label>
                                            <textarea type="text" name="address" required class="form-control form-control-user"
                                                placeholder="Enter Company Address...">{{ $supplier->address }}</textarea>
                                        </div>
                                        @if ($errors->any())
