                            ...
                            <div class="col-lg-12">
                                <div class="p-3">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Stock In</h1>
                                    </div>
                                    <form method="POST" action="{{ route('stock.in.store') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">
                                                        Supplier <sup class="text-danger">*</sup>
                                                    </label>
                                                    <select name="supplier_id" class="form-control form-control-user">
                                                        @foreach ($supplier as $item)
                                                            <option value="{{ $item->id }}">
                                                                {{ $item->company_name }} ({{ $item->pic_name }})
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
